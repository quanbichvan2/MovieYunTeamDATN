...
{
    public class VoucherForCreateDtoValidation : AbstractValidator<VoucherForCreateDto>
    {
        public VoucherForCreateDtoValidation(IVoucherRepository voucherRepository)
        {
            RuleFor(x => x.Name)
