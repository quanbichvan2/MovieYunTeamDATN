...
{
    public class ProductGetAllQueryHandler : IRequestHandler<ProductGetAllQuery, PaginatedList<ProductForViewDto>>
    {
        ...
        public async Task<PaginatedList<ProductForViewDto>> Handle(ProductGetAllQuery request, CancellationToken cancellationToken)
        {
            try
            {
                var query = _productRepository.GetAll();
                var allowedProductProperties = new List<string> { "Name", "Price"};
